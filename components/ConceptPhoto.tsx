...
const ConceptPhoto: NextComponentType<NextPageContext, {}, Props> = ({
    ...
    return (
        <div className="overflow-hidden rounded-xl bg-gray-200 p-1 shadow-lg">
            <Image
                src={imageUrl}
                className="h-56 w-auto cursor-zoom-in rounded-lg hover:opacity-70 lg:h-80"
                width={500}
                height={500}
            ...
            >
                <div className="container relative flex h-5/6 p-2">
                    <button
                        ...
                        className="absolute top-3 right-3 inline-flex items-center rounded-lg bg-black/50 p-1 text-sm text-gray-200 hover:bg-gray-400 hover:text-white"
                    >
                        <svg
                            className="h-8 w-8"
                            fill="currentColor"
